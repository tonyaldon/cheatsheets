...
- [[https://elpa.gnu.org/packages/rainbow-mode.html][rainbow-mode]] package (maybe interesting with i3-conf mode where there is color #ffffff in the configuration)
...
- [[https://melpa.org/#/goto-last-point][goto-last-point]]
* Discarded packages
