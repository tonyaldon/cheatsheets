...
** Other
   - subword package [[/home/tony/work/apps/emacs/lisp/progmodes/subword.el]]
   - diff-hl.el package -> Diff highlights in the fringe (https://protesilaos.com/dotemacs/)
   - column-number-mode
   - https://github.com/benma/emacs.d/blob/master/init.el (section fill-column-indicator & company/fill-column-indicator)
	 - javascript:
