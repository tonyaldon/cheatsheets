...
- See [[https://wiki.archlinux.org/index.php/Persistent_block_device_naming][persistent block device naming]] from archilinux wiki.
...
** Miscellaneous commands
  ...
  rm, kill, killall, gparted, alias, unalias
** terminal
*** Current terminal
